...
class Darwin_finches(Hypothesis):
    def __init__(self):
        ...
        scandens_data = pd.read_csv('scandens_beak_depth_heredity.csv',  header=0)
        fortis_data   = pd.read_csv('fortis_beak_depth_heredity.csv', header=0)
    ...
    def EDA_heritability(self,bd_parent_scandens, bd_offspring_scandens, bd_parent_fortis, bd_offspring_fortis):
    ...
    def Pearson_correlation_coefficient(self,bd_parent_scandens, bd_offspring_scandens, bd_parent_fortis, bd_offspring_fortis, pearson_r, draw_bs_pairs):
    ...
    def Exercise_Measuring_heritability(self,bd_parent_scandens, bd_offspring_scandens, bd_parent_fortis, bd_offspring_fortis,draw_bs_pairs):
    ...
    def beak_depth_heritable (self,bd_parent_scandens, bd_offspring_scandens,heritability_scandens, heritability ):
